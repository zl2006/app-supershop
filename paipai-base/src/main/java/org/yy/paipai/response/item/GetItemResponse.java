...
/*
* 文 件 名:  GetItemResponse.java
* 版    权:  YY Technologies Co., Ltd. Copyright 2012-2013,  All rights reserved
* 描    述:  查询单个商品详细信息,http://pop.paipai.com/api/paipai/item/getItem响应
* 修 改 人:  zhouliang
* 修改时间:  2014年11月28日
* 修改内容:  <修改内容>
*/
...
import org.yy.paipai.model.ItemAttr;
import org.yy.paipai.model.ItemExtendAttr;
import org.yy.paipai.model.Stock;

/**
* 查询单个商品详细信息,http://pop.paipai.com/api/paipai/item/getItem响应
* 
* @author  zhouliang
...
public class GetItemResponse extends PaiPaiResponse {
     ...
     * 注释内容
     */
    private static final long serialVersionUID = 6117903486722347076L;
     ...
     * 商品的属性列表
     */
    private List<ItemAttr> parsedAttrList;
    
    /**
     * 商品扩展属性列表
     */
    private List<ItemExtendAttr> extendList;
    ...
    */
    ...
    /**
    * @return 返回 parsedAttrList
    */
    public List<ItemAttr> getParsedAttrList() {
        return parsedAttrList;
    }

    /**
    * @param 对parsedAttrList进行赋值
    */
    public void setParsedAttrList(List<ItemAttr> parsedAttrList) {
        this.parsedAttrList = parsedAttrList;
    }

    /**
    * @return 返回 extendList
    */
    public List<ItemExtendAttr> getExtendList() {
        return extendList;
    }

    /**
    * @param 对extendList进行赋值
    */
    public void setExtendList(List<ItemExtendAttr> extendList) {

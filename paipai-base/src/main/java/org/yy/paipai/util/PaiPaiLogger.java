...
import org.yy.paipai.api.Constants;
...
public class PaiPaiLogger {
    ...
    public static void setNeedEnableLogger(boolean needEnableLogger) {
        PaiPaiLogger.needEnableLogger = needEnableLogger;
    }
     ...
     * 通讯错误日志
     */
    private static void _logCommError(Exception e, HttpURLConnection conn, String url, String appKey, String method,
        Map<String, String> params) {
    ...
    public static void logErrorScene(Map<String, Object> rt, PaiPaiResponse tRsp, String appSecret) {
        if (!needEnableLogger) {
            return;
        }
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        ...
        sb.append("^_^");
        sb.append(tRsp.getErrorMessage());
        sb.append("^_^");
        ...
        appendLog((Map)rt.get("protocalMustParams"), sb);
        sb.append("^_^");
        sb.append("ProtocalOptParams:");
        appendLog((Map)rt.get("protocalOptParams"), sb);
        sb.append("^_^");
        sb.append("ApplicationParams:");
        appendLog((Map)rt.get("textParams"), sb);
        sb.append("^_^");
        sb.append("Body:");

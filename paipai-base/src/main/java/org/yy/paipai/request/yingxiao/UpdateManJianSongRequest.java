...
/*
* 文 件 名:  UpdateManJianSongRequest.java
...
*/
public class UpdateManJianSongRequest extends AbstractPaiPaiRequest<PaiPaiResponse> {
    ...
    */
    ...
    /**
    *活动内容,数组,一个或多个活动规则,详见以下说明.标准json数组,如:[{'参数名1':'值1','参数名2':'值2'},{'参数名3':'值3'}]
    */

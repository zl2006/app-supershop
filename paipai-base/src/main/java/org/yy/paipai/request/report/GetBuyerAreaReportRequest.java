...
/*
* 文 件 名:  GetBuyerAreaReportRequest.java
* 版    权:  YY Technologies Co., Ltd. Copyright 2012-2013,  All rights reserved
* 描    述:  查询拍拍买家地域分析统计 ,http://pop.paipai.com/api/paipai/report/getBuyerAreaReport请求
* 修 改 人:  zhouliang
* 修改时间:  2014年11月28日
* 修改内容:  <修改内容>
*/
import org.yy.paipai.request.AbstractPaiPaiRequest;
import org.yy.paipai.response.report.GetBuyerAreaReportResponse;

/**
* 查询拍拍买家地域分析统计 ,http://pop.paipai.com/api/paipai/report/getBuyerAreaReport请求
* 
* @author  zhouliang
* @version  [0.1, 2014年11月28日]
* @since  [paipai-base/0.1]
*/
public class GetBuyerAreaReportRequest extends AbstractPaiPaiRequest<GetBuyerAreaReportResponse> {
    
    /** {@inheritDoc} */
    @Override
    public String getApiMethodName() {
        return "/report/getBuyerAreaReport.xhtml ";
    }
    
    /** {@inheritDoc} */
    @Override
    public Class<GetBuyerAreaReportResponse> getResponseClass() {
        return GetBuyerAreaReportResponse.class;
    }
